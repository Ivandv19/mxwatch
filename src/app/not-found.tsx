        ...
        <div className="relative w-full flex flex-col items-center justify-center min-h-[calc(100dvh-64px)] px-8 text-center py-20 overflow-hidden bg-[#080c12]">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="mt-12 flex flex-col sm:flex-row gap-4">
                    <Link href="/" className="group relative inline-flex h-12 md:h-14 items-center justify-center rounded-lg bg-accent px-8 text-base font-semibold text-white transition-all hover:bg-accent-hover hover:-translate-y-0.5 shadow-[0_0_30px_-10px_var(--accent-glow)]">
                    ...
                    <Link href="/mapa" className="inline-flex h-12 md:h-14 items-center justify-center rounded-lg border border-white/10 bg-white/5 px-8 text-base font-semibold text-[#f0f4ff] transition-all hover:bg-white/10">
                        Explorar Mapa
                    </Link>
                </div>
            </div>
            ...
            <div className="absolute inset-0 opacity-[0.02] pointer-events-none" style={{ backgroundImage: "linear-gradient(rgba(255,255,255,0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.2) 1px, transparent 1px)", backgroundSize: "40px 40px" }} />
        </div>
    );
}