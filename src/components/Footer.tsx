    ...
    return (
        <footer className="w-full border-t border-white/10 bg-[#080c12] mt-auto transition-colors duration-300">
            <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
                            ...
                            />
                            <button type="submit" className="px-4 py-2 rounded-md bg-accent text-white font-medium text-sm hover:bg-accent-hover transition-colors shadow-lg shadow-accent/10">
                                Suscribirse
                            </button>
                        </form>
                    </div>
                ...
                {/* Barra inferior: Créditos, Tecnologías y Copyright */}
                <div className="border-t border-white/10 pt-12 flex flex-col items-center gap-8">
                    ...
                    <div className="flex flex-col items-center gap-5">
                        <p className="text-sm font-medium text-[#8b98b8]">
                            Desarrollado por <span className="font-bold text-[#f0f4ff]">Sinx</span>
                        </p>
